...
public class RelacaoComposicao extends RelacaoUML{
    ...
    public RelacaoComposicao(DiagramaUML diagramaUML) {
        super(diagramaUML);
    ...
    void colocarEstiloDePreview() {
        ...
        labelSeta.setIcon(new ImageIcon( switch (sentidoDaSeta) {
            case "Norte" -> RelacaoGeneralizacao.class.getResource("/imagens/previewDeRelacoes/composicaoNortePreview.png");
            case "Sul" -> RelacaoGeneralizacao.class.getResource("/imagens/previewDeRelacoes/composicaoSulPreview.png");
            case "Leste" -> RelacaoGeneralizacao.class.getResource("/imagens/previewDeRelacoes/composicaoLestePreview.png");
            case "Oeste" -> RelacaoGeneralizacao.class.getResource("/imagens/previewDeRelacoes/composicaoOestePreview.png");
            default -> throw new IllegalStateException("Erro");
        }));
    ...
    public void colocarEstiloFinal() {
        ...
        labelSeta.setIcon(new ImageIcon( switch (sentidoDaSeta) {
            case "Norte" -> RelacaoGeneralizacao.class.getResource("/imagens/relacoesFinalizada/composicaoNorteFinal.png");
            case "Sul" -> RelacaoGeneralizacao.class.getResource("/imagens/relacoesFinalizada/composicaoSulFinal.png");
            case "Leste" -> RelacaoGeneralizacao.class.getResource("/imagens/relacoesFinalizada/composicaoLesteFinal.png");
            case "Oeste" -> RelacaoGeneralizacao.class.getResource("/imagens/relacoesFinalizada/composicaoOesteFinal.png");
            default -> throw new IllegalStateException("Erro");
        }));
    }
    ...
    public void adicionarComportamentoArelacao() {
        ...
        JLabel labelComposicao = new JLabel("COMPOSIÇÃO", JLabel.CENTER);
        ...
        MouseAdapter mouseAdapter = new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                labelSeta.setIcon(new ImageIcon( switch (sentidoDaSeta) {
                    case "Norte" -> RelacaoDependencia.class.getResource("/imagens/gerenciarRelacoes/composicaoNorteGerenciar.png");
                    case "Sul" -> RelacaoDependencia.class.getResource("/imagens/gerenciarRelacoes/composicaoSulGerenciar.png");
                    case "Leste" -> RelacaoDependencia.class.getResource("/imagens/gerenciarRelacoes/composicaoLesteGerenciar.png");
                    case "Oeste" -> RelacaoDependencia.class.getResource("/imagens/gerenciarRelacoes/composicaoOesteGerenciar.png");
                    default -> throw new IllegalStateException("Erro");
                }));

                for (JComponent componenteDeRelacao : RelacaoComposicao.super.getListaPaineisRelacao()) {
