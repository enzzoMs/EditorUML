...
public class GerenciadorInterfaceGrafica {
    ...
    private final GerenciadorDeRecursos gerenciadorDeRecursos = GerenciadorDeRecursos.getInstancia();
    ...
    public GerenciadorInterfaceGrafica() {
        ...
        framePrincipal.setIconImage(gerenciadorDeRecursos.getImagem("app_icone"));
